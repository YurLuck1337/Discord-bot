...
client.on('messageDelete', message =>{ // ивент, когда удаляется любое сообщение с сервера https://discord.js.org/#/docs/main/stable/class/Client?scrollTo=e-guildMemberAdd
  ...
  client.channels.cache.get("844995187331039243").send(embed); // айди вашего канала с логами
})
...
client.on('guildMemberAdd', member =>{ // ивент, когда пользователь присоединяется к серверу https://discord.js.org/#/docs/main/stable/class/Client?scrollTo=e-guildMemberAdd
    ...
    .setFooter('844994596463444008', 'https://cdn.discordapp.com/emojis/590614597610766336.gif?v=1')
    ...
    .setColor('RANDOM')
    member.send(embed);
    client.channels.cache.get('844995187331039243').send(embed2) // айди вашего канала с логами
})
...
async function change() {
    ...
    client.channels.cache.get("844994596463444008").setName(`На сервере: ${members}`); // свой айди войса
}

var interval = setInterval(function () { change(); }, 20000  ); // время обновления в миллисекундах

client.login('ODQ0OTkyNjQ4MTU4MzgwMDUy.YKaeug.wPmyLM_boGRFbPDZ2__7lBDN5Ns') // токен вашего бота
